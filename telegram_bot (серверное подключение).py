...
def get_text_messages(message):
    if message.text == '/check_in':
        checkReg = requests.get('https://tc21.e-office24.ru/57021/600_112212/hs/tickets/v1/check_registered', headers={'username': message.from_user.username})
        # print(checkReg.status_code)
        if checkReg.status_code == 200:
            result = requests.get('https://tc21.e-office24.ru/57021/600_112212/hs/tickets/v1/all_actions')
...
def callback_worker(call):
    if call.data.startswith('%1'):
        ...
        action = dta.pop(0)[2:]
        time = ' '.join(dta)
        result = requests.post('https://tc21.e-office24.ru/57021/600_112212/hs/tickets/v1/check_time',
        ...
        if result.status_code == 200 or result.status_code == 201:
            ...
            bot.send_message(call.message.chat.id, "Вас обслужит первый освободившийся оператор")
...
def check_password(message):
    result = requests.get('https://tc21.e-office24.ru/57021/600_112212/hs/registration/v1/newuser', headers={'num': message.text, 'username': message.from_user.username})
